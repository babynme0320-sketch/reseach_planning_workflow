...
description: Business automation project harness for Antigravity agents. Use for project-start, execute-task, and review-project workflows with artifacts and verification.
---

# Project Harness Skill for Antigravity
...
## Antigravity Artifacts Rule

When working in Antigravity, produce verifiable Artifacts whenever possible:

- Plan Artifact before implementation
- Task List Artifact during execution
- Terminal/test result Artifact after validation
- Screenshot/browser Artifact for UI verification
- Review Artifact for final inspection
